...
/*
SOL_Compost.cpp - Library for composter variable monitoring
...
void Composter::readandcheckAll()
{
    readDHT();
    checkH();
    checkT();
...
// Reading via ADS1115
void Composter::readWeight_I2C_onesample()
{
...
// Reading via ADS1115
void Composter::readWeight_I2C_Nsamples(int Nsamples)
{
