/*
  getStatus.ino - Simple test for composter variable reading
...
Composter Composter1(DHTPin, buttonPin, relayPin, oneWirePin);
...
void loop()
{
  Composter1.readandcheckAll();
  Composter1.getStatus();
